    ...
    stages {
        ...
        stage ('Deploy') {
            ...
            steps {
                ...
                sh "ps -ef | grep 'java -jar -Dspring.profiles.active=oauth-security,prod /home/projetos/\$PROJETO_GIT/deploy/\$PROJETO_GIT.jar' | grep -v grep | awk '{ print \$2 }' | xargs --no-run-if-empty kill"
